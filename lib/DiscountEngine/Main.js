...
class DiscountEngineMain {
  ...
  async perform() {
    ...
    console.log('--cartDataWithProductSpecificOffer--',cartDataWithProductSpecificOffer);
    let  cartSpecificDetails = await oThis._applyCartSpecificDiscount(cartDataWithProductSpecificOffer),
      responseObject = {
        products: cartDataWithProductSpecificOffer,
      };
    
    console.log('-cartSpecificDetails--', cartSpecificDetails);
